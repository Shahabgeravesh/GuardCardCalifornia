...
const studyQuestions = [
  ...
  },
  {
    ...
    explanation: 'Security guards cannot make ADA qualification decisions - that is not their role.'
  },
  {
    id: '38',
  ...
  },
  {
    ...
    options: ['Illness', 'Drugs', 'Either one'],
    correctAnswer: 2,
    category: 'Mental Health',
    explanation: 'Hallucinations can be caused by either illness or drugs, or both.'
  },
  {
    id: '41',
    ...
    explanation: 'Self-control gives guards better situational awareness and decision-making ability.'
  },
  {
    id: '42',
    ...
    explanation: 'Fear and anger are the two primary emotions that must be controlled in security work.'
  },
  {
    id: '43',
    ...
    correctAnswer: 2,
    category: 'Use of Force',
    explanation: 'Always try to gain compliance without physical force, using verbal techniques first.'
  },
  {
    id: '44',
    ...
    explanation: 'Public trust is built by ensuring that any force used is reasonable and necessary.'
  },
  {
    id: '45',
    ...
    explanation: 'A good guard acts with supportiveness, helping and protecting people rather than being intimidating.'
  },
  {
    id: '46',
    ...
    correctAnswer: 0,
    category: 'Mental Health',
    explanation: 'Mental illness may reduce someone\'s coping abilities and their ability to respond appropriately to situations.'
  },
  {
    id: '47',
    ...
    correctAnswer: 1,
    category: 'Mental Health',
    explanation: 'Security officers should not try to diagnose mental illness - that is not their role.'
  },
  {
    id: '48',
...
const Quiz1Screen = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.systemBackground }]}>
            ...
            <View style={styles.contentSection}>
              ...
              <View style={[styles.consolidatedCard, { backgroundColor: theme.colors.secondarySystemBackground }, theme.shadows.lg]}>
                ...
                <View style={styles.cardContent}>
                  <Text style={[styles.mainDescription, { color: theme.colors.label }, theme.typography.body]}>
                    This practice quiz covers essential topics from the mandatory 4-hour Power to Arrest training required by the California Bureau of Security and Investigative Services (BSIS) for all security guard applicants.
                  </Text>
                  ...
                  <View style={styles.topicsSection}>
                    ...
                    <View style={styles.topicsGrid}>
                      <View style={styles.topicItem}>
                        <Ionicons name="checkmark-circle" size={20} color={theme.colors.systemGreen} />
                        <Text style={[styles.topicText, { color: theme.colors.secondaryLabel }, theme.typography.body]}>
                  ...
                  <View style={[styles.disclaimerSection, { backgroundColor: 'rgba(255, 193, 7, 0.1)', borderColor: 'rgba(255, 193, 7, 0.3)' }]}>
                    ...
                    <Text style={[styles.disclaimerText, { color: theme.colors.secondaryLabel }, theme.typography.body]}>
                      This is a practice quiz only and will not certify you as a security guard. You must complete official BSIS-approved training and pass the actual exam to obtain your guard card license.
                    </Text>
                  </View>
                </View>
              </View>
      ...
      {/* Navigation Bar - Only show when quiz is started */}
      {quizStarted && (
        <View style={[styles.navigationBar, { backgroundColor: theme.colors.systemBackground, borderTopColor: theme.colors.separator }]}>
          ...
          <TouchableOpacity
            style={[styles.exitButton, { backgroundColor: theme.colors.systemOrange }]}
            onPress={exitQuiz}
            accessibilityLabel="Exit quiz"
            accessibilityHint="Exit quiz and return to information screen"
          >
            <Text style={[styles.exitButtonText, { color: '#FFFFFF' }, theme.typography.headline]}>Exit</Text>
          </TouchableOpacity>
